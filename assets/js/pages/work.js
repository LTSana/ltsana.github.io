...
document.addEventListener("DOMContentLoaded", () => {
        ...
        // For good (high) scores
          ...
          speedscore.numberScale = setInterval(() => {
              if (counter >= (json.lighthouseResult.categories["performance"].score * 100)) {
                  ...
                  document.querySelector(`#score-holder-${speedscore.dataset.score_id}`).innerHTML = (json.lighthouseResult.categories["performance"].score * 100).toFixed(0);
              } else {
	...
	function setUpQuery(website) {
		...
		// Add API key
		query += "&key=AIzaSyBvDxNbRpSL2G1HAZ3gj15RpO35ALbyrGA";
